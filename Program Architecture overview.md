...
* Relevant classes ('person) from COCO 2017 was downloaded from [__FiftyOne__](https://docs.voxel51.com/user_guide/dataset_zoo/datasets.html) using [__this code__]  
