...
* Install OpenPose: "$ sudo make install" and set the OpenPose path in python scripts to the OpenPose installation path (default: /usr/local/python ) and use OpenPose at any
